...
<template>
  <main id="result_main_container">
    <div id="wpm_acc_time_container">
      <div class="wpm_acc_time_class">wpm {{ result_data.wpm }}</div>
      <div class="wpm_acc_time_class">correct rate {{ result_data.acc }} %</div>
      <div class="wpm_acc_time_class">time {{ result_data.time.toFixed(2) }} </div>
    </div>
