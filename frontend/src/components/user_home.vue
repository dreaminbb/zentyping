...
import {ref, inject, type Ref,  provide} from 'vue'
...
<template>
  ...
  <div id="button_frame">
    ...
    <router-link to="/write" id="write" class="button_rwp">
      <svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon"
          height="50px"
    ...
    <router-link to="/play" id="play" class="button_rwp">
      <svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon"
          height="50px"
...
.button_rwp:hover {
  animation: hover_animetion ease 1s forwards;
}

@keyframes hover_animetion {
  100% {
    ...
    animation: hover_animetion ease 1s;
  }
}
