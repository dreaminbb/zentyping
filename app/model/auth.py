...
class cookie_maneger:
    ...
    # def verify_update_refresh(self, access_token: str | None) -> Response:
    #     try:
    #         try:
    ...
    #                 )
    #             payload = jwt.decode(
    #                 jwt_token, key=self.key, algorithms=[self.algorithm]
    #             )
    #             sub = payload["sub"]
    ...
    #                 return make_response(
    #                     {"message": config.TOKEN_OWNER_NOT_FOUND_MESSAGE}, 404
    #                 )
    #         except jwt.ExpiredSignatureError:
    #             db["invalid_tokens"].insert_one(
    #                 {
    ...
    #                 }
    #             )
    #             return make_response({"message": config.TOKEN_TIMEOUT_MESSAGE}, 401)
    ...
    #         )
    #         print(e)
    #     return make_response({"message": config.INVALID_TOKEN_MESSAGE}, 401)
